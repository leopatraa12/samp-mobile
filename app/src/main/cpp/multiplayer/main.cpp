...
extern "C" {
	JNIEXPORT void JNICALL Java_com_aurora_game_SAMP_initializeSAMP(JNIEnv *pEnv, jobject thiz)
	{
		pJavaWrapper = new CJavaWrapper(pEnv, thiz);

	}
	JNIEXPORT void JNICALL Java_com_aurora_game_SAMP_onInputEnd(JNIEnv *pEnv, jobject thiz, jbyteArray str)
	{
		if(pUI)
		{
	...
	JNIEXPORT void JNICALL Java_com_aurora_game_SAMP_onEventBackPressed(JNIEnv *pEnv, jobject thiz)
	{
		if(pSettings)
		{
	...
	JNIEXPORT void JNICALL Java_com_aurora_game_ui_dialog_DialogManager_sendDialogResponse(JNIEnv* pEnv, jobject thiz, jint i3, jint i, jint i2, jbyteArray str)
	{
...
Java_com_aurora_game_ui_Hud_clickCameraMode(JNIEnv *env, jobject thiz) {
//
    if(!pNetGame)return;
...
extern "C"
JNIEXPORT void JNICALL
Java_com_aurora_game_ui_Hud_nativeSetRadarPos(JNIEnv *env, jobject thiz, jfloat x, jfloat y, jfloat width, jfloat height) {
    radarPos.x = x;
    radarPos.y = y;
    radarSize.x = width;
    radarSize.y = height;
...
extern "C"
JNIEXPORT void JNICALL
Java_com_aurora_game_ui_Hud_SetRadarBgPos(JNIEnv *env, jobject thiz, jfloat x1, jfloat y1,
                                               jfloat x2, jfloat y2) {
    radarBgPos1.x = x1;
    radarBgPos1.y = y1;
    radarBgPos2.x = x2;
